...
const mockMessages: Messages = {
    chat1: [
        ...
        {
            id: '5',
            text: 'Você pode me ajudar com um problema?',
            senderId: '123',
            receiverId: '456',
        ...
        {
            id: '7',
            text: 'Estou com dificuldade em entender o conceito de closures em JavaScript.',
            senderId: '123',
            receiverId: '456',
        ...
        {
            id: '8',
            text: 'Muito obrigado pela explicação!',
            senderId: '123',
            receiverId: '456',
        ...
        {
            id: '9',
            text: 'De nada! Se precisar de mais alguma coisa, estarei aqui.',
            senderId: '456',
            receiverId: '123',
    ...
    chat2: [
        {
            id: '1',
            text: 'Olá, você está disponível para uma reunião?',
            senderId: '456',
            receiverId: '123',
            timestamp: '2023-10-01T12:00:00Z'
        },
        {
            id: '2',
            text: 'Sim, estou disponível. Quando seria?',
            senderId: '123',
            receiverId: '456',
            timestamp: '2023-10-01T12:01:00Z'
        },
...
export default function ChatView() {
    ...
    const example = mockMessages[chatId];
    ...
    const renderMessageItem = ({ item }: { item: Messages[keyof Messages][0] }
    ) => (
        <MessageBalloon
            text={item.text}
            sender={item.senderId === currentUserId ? 'me' : 'them'}
            image={item.image}
        />
    );
